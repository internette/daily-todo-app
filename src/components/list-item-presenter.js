...
const ListItemPresenter = ( props ) => {
  ...
  const details_elm_content = props.editable ? <textarea defaultValue={props.details} onChange={(e)=> {props.updateDetails(props.id, e.target.value)}} autoFocus></textarea> : <div>{props.details}</div>
